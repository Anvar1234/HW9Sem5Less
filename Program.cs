...
2. В задаче 36 за "нечетные позиции" элементов массива принял нечетный порядковый номер элементов массива, а
не индекс!!! Т.е. элемент на позиции №1 - это элемент с индексом №0. Прошу учесть.
3. В задаче 38 реализовал метод поиска мин и макс в массиве параллельным? поиском с обоих концов массива. Не знаю,
...
//Здесь принял, что "нечетные позиции" здесь - это нечетный порядковый номер элементов массива!!!
//Т.е. элемент на первой позиции - это элемент с индексом 0.
